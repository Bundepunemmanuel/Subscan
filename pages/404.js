...
export default function NotFound() {
  return (
    <>
      ...
      <div className="page">
        <div className="banner">Kairo monitors pain signals 24/7 automatically.&nbsp;<a href="https://kairo-app.carrd.co" target="_blank" rel="noopener noreferrer">Join the waitlist →</a></div>
        <main style={{flex:1}}>
